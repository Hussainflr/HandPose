...
def get_skeleton(sample, skel_root):
    ...
    print(" Original shape at skeleton : ", skeleton_vals.shape)
    skeleton = skeleton_vals[:, 1:].reshape(skeleton_vals.shape[0], 21,
                                            -1)[sample['frame_idx']]
    print("Reshaped ", skeleton.shape)
    return skeleton
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', default='../data/First_Person_Action_Benchmark')
    parser.add_argument('--subject', default='Subject_1')
    parser.add_argument('--action_name', default='open_liquid_soap')
    parser.add_argument('--seq_idx', default='2')
    parser.add_argument('--frame_idx', default=0, type=int)
    parser.add_argument('--obj', default='liquid_soap', choices=['liquid_soap', 'juice', 'milk', 'salt'])
    ...
    if args.obj is not None:
        ...
        print("Obj Trans", obj_trans.shape, obj_trans)
        # Get object vertices
    ...
    print("Image shape", skel_proj.shape)
    print("Object vertixes : ", verts_proj.shape)
    ax.imshow(img)
