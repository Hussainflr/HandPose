...
class UnifiedPoseDataset(Dataset):
    ...
    def preprocess(self, idx):
        ...
        #print("Object category :", object_category[sample['object']])
        true_object_prob[z, v, u] = object_category[sample['object']]
        #print('True Object probability: ', true_object_prob)
        ...
        hand_mask[z, v, u] = 1
        #ex =  np.nonzero(hand_mask)[0]
        #print("Hand Mask", hand_mask[z, v, u])

        # hand action tensor
        true_hand_prob = torch.zeros(5, 13, 13, dtype=torch.long)
        #print("action name :", action_category[sample['action_name']])

        true_hand_prob[z, v, u] = action_category[sample['action_name']]
        #print("True Hand Probability", true_hand_prob[z, v, u])
        #print(true_hand_prob)
        image = None
        ...
        if self.loadit:
            ...
            # plt.imshow(img)
            # plt.show()
            image, image_path = self.get_image(sample)
        ...
        return image, image_path, object_pose, true_hand_pose, true_hand_prob, hand_mask, true_object_pose, true_object_prob, object_mask
        #MC End
